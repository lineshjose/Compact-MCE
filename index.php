...
/*
	...
	Version: 16.06
	Plugin URI: http://linesh.com/projects/compact-mce/
...
// Adding plugin meta links  -------------------->
	function lj_cmce_plugin_actions( $links, $file )	
	{
		...
		if ($file == $plugin) {
		$links[] = '<a href="http://linesh.com/make-a-donation/" target="_blank">
						<span class="dashicons dashicons-heart"></span>' . __('Donate','cas'  ) . '</a>';
		$links[] = '<a href="http://linesh.com/forums/forum/plugins/compact-mce/" target="_blank">
						<span class="dashicons dashicons-sos"></span>' . __('Support', 'cas'  ) . '</a>';
		}
		return $links;
	}
